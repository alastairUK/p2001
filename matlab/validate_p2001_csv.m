...
% Recommendation ITU-R P.P2004 (as defined in the file tl_p2001.m and the
...
%                 Created new validate_p2001_csv.m that handles .csv files
...
test_profiles = [s '/validation_examples_csv/'];
test_results  = [s '/validation_results_csv/'];
...
%% verify error in the results delta against tolarance
